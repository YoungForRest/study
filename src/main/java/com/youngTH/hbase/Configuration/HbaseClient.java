package com.youngTH.hbase.Configuration;
...
public class HbaseClient {
    ...
    public static void init() {
        ...
        //注意。这里这行目前注释掉的 是要根据自己zookeeper.znode.parent的配置信息进行修改。
//        configuration.set("zookeeper.znode.parent","/hbase-unsecure"); //与 hbase-site-xml里面的配置信息 zookeeper.znode.parent 一致
        configuration.set("hbase.zookeeper.quorum","10.2.111.54");  //zookeeper 服务地址
